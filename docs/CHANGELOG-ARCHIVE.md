# Gumi Brand — 前端改动记录（归档：第一～三十轮）

> 2026-08-27 从 [CHANGELOG.md](CHANGELOG.md) 分卷而来，**原文未改一字**。
> 当前轮次的记录在 CHANGELOG.md；这里只放第一～三十轮（2026-08-19 ～ 08-25）。
> 查历史用 `grep -n <关键词> docs/CHANGELOG*.md` 两份一起搜。
